            ...
            <div className="px-5 py-4 bg-white dark:bg-gray-800 shadow rounded-lg  w-full">
                <div className="flex mb-4">
                    ...
                    <div className="ml-2 mt-0.5">
                        <span className="block font-medium text-base leading-snug text-black dark:text-gray-100">{user.name}</span>
                        <span className="block text-sm text-gray-500 dark:text-gray-400 font-light leading-snug">{new Date(data.date).toLocaleDateString()}</span>
                    </div>
                ...
                <p className="text-gray-800 dark:text-gray-100 leading-snug md:leading-normal">{data.text}</p>
