...
export default function Login() {
  ...
  const [category, setCategory] = useState("Hundskötsel")
        ...
        <form className="w-full max-w-lg" onSubmit={(e) => createPost(e)}>
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3 mb-6 md:mb-0">
              ...
              <input  type="text" value={title} className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-4 py-2.5" onChange={(e) => setTitle(e.target.value)} placeholder="Hur tycker ni om..?" />
            ...
            <div className="w-full px-3 mb-6 md:mb-0">
              ...
              <div className="relative">
                <select className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-4 py-2.5" onChange={(e) => setCategory(e.target.value)}>
                    <option defaultValue value={"Hundskötsel"}>Hundskötsel</option>
          ...
          <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Skapa nytt inlägg</button>
