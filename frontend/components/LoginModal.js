                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="py-6 px-6 lg:px-8">
                        ...
                        <form className="space-y-6" action="#">
                            <div>
                                <label for="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Din email</label>
                            ...
                            <div>
                                <label for="password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ditt lösenord</label>
                            ...
                            <div className="flex justify-between">
                                <div className="flex items-start">
                                    ...
                                    <label for="remember" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Kom ihåg mig</label>
                                </div>
                            </div>
                            ...
                            <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                                Inte registerad? <a href="/create" className="text-blue-700 hover:underline dark:text-blue-500">Skapa konto</a>
                            </div>
                        </form>
                    </div>
                </div>
